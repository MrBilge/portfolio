...
const MySkills = [
  {
    icon: <Image loading="lazy" src="/assets/html5.png" alt="HTML & CSS" className="w-20 h-20" />,
    name: "HTML & CSS",
    description:
  ...
  {
    icon: <Image loading="lazy" src="/assets/js.png" alt="JavaScript" className="w-20 h-20" />,
    name: "JavaScript (ES6+)",
    description:
      "Developing dynamic and interactive web features using modern JavaScript practices and clean, maintainable code.",
  },
   {
    icon: <Image loading="lazy" src="/assets/tailwind.png" alt="Tailwind CSS" className="w-20 h-20" />,
    name: "Tailwind CSS",
    description:
   ...
   {
    icon: <Image loading="lazy" src="/assets/react.png" alt="React" className="w-20 h-20" />,
    name: "React",
    description:
  ...
  {
    icon: <Image loading="lazy" src="/assets/nextjs.png" alt="Next.js" className="w-20 h-20" />,
    name: "Next.js",
    description:
  ...
  {
    icon: <Image loading="lazy" src="/assets/jquery.png" alt="jQuery" className="w-20 h-20" />,
  ...
  {
    icon: <Image loading="lazy" src="/assets/aspnet.png" alt="ASP.NET MVC / Razor Pages" className="w-24 h-20" />,
  ...
  {
    icon: <Image loading="lazy" src="/assets/expo.png" alt="React Native Expo" className="w-20 h-20" />,
    name: "React Native (Expo)",
    description:
      "Building cross-platform mobile applications with reusable components and a streamlined development workflow.",
  },
  {
    icon: <Image loading="lazy" src="/assets/figma.png" alt="Figma" className="w-14 h-20" />,
    name: "Figma",
    description:
      "Designing and translating UI concepts into clean, developer-friendly components with attention to layout and usability.",
  },
  {
    icon: <Image loading="lazy" src="/assets/github.png" alt="Git & GitHub" className="w-32 h-20" />,
    name: "Git & GitHub",
    description:
