...
export function Hero({ onScrollClick }: HeroProps) {
  return (
    <div className="sm:flex-reverse lg:flex  h-screen w-full justify-between bg-[url('/assets/bilge.png')] bg-no-repeat px-5 lg:px-15  bg-center ">
      <div className="flex flex-col justify-center lg:justify-start lg:gap-20  sm:w-1/2 mt-0 lg:mt-40  ">
<div className="hidden lg:block  w-36 h-[10px]  bg-white/10 rounded-full">
</div>
      ...
      <div className="hidden md:flex flex-col w-1/2 md:w-1/3 mt-20 lg:mt-0 lg:mb-90  space-y-5 xl:space-y-10 text-xs">
