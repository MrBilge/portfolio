export default function AboutMe() {
  return (
    <div className="h-screen  flex flex-col     bg-white/2   space-y-5 justify-center items-center md:flex-row md:justify-between gap-5 sm:gap-10  px-5 lg:px-40 text-white/60  ">
